...
<p align="justify">Aqui está a tabela completa com todas as métricas calculadas para as suas 20 perguntas, extraídas diretamente dos resultados do seu processo de avaliação com Ragas.</p>
...
<p align="justify">* Context Recall (1.0 constante): O seu banco de dados vetorial (Redis + Embeddings) está perfeito. Ele sempre encontra a página certa do PDF.</p>
